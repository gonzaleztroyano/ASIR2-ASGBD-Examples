-- La empresa va a sufrir obras en la sede en la que se encuentra el despacho “1” y 
-- todos los trabajadores de este despacho se van a tener que trasladar al despacho “5”. Recorre la tabla de DIRECTORES,
--  registro a registro, actualizando la información para que nuestra base de datos recoja esta circunstancia.
DELIMITER $$
