-- Haz lo necesario para cada vez que hay un movimiento  se actualice el saldo de la cuenta de ese cliente 
-- con ese movimiento, ya se un ingreso o una retirada.
DELIMITER $$
