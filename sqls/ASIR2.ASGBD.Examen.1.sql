...
-- • Cuando un producto se pida mas de tres veces en un pedido que se haga en
--      domingo este producto aumente su precio un 15% (Tabla productos).
-- • Se reste las unidades del producto que se han realizado en el pedido del stock en
--     la tabla productos
